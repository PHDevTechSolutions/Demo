...
const CSRMetrics: React.FC<CSRMetricsProps> = ({ filteredAccounts }) => {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6 font-sans overflow-x-auto text-black">
      ...
      {showComputation && (
        <div className="bg-gray-50 border rounded-lg p-4 mt-6 text-xs space-y-2">
          <h3 className="font-bold mb-2">Computation Details</h3>
          <ul className="list-disc ml-5 space-y-1">
            <li>
              <b>Response Time</b> = End Date − Start Date (for all CSR Inquiry records)
            </li>
            <li>
              <b>RFQ Handling Time</b> = Response Time (only if Activity Status = Quote-Done)
            </li>
            <li>
              <b>Non-RFQ Handling Time</b> = Response Time (only if Activity Status = Assisted)
            </li>
            <li>
