...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, isDarkMode }) => {
  ...
  const filteredMenuItems = useMemo(() => {
    ...
    const allowed: Record<string, string[]> = {
      ...
      "Manager": ["Session Logs","Sales Performance","Conversion Rates","National","My Team","Client Activity Board","Help Center","Xend Mail","Global Employees","My Profile","What is Taskflow?"],
      "Special Access": ["Customer Database","Activities","Sales Performance","Conversion Rates","National","My Team","Client Activity Board","Help Center","Xend Mail","Global Employees","My Profile","What is Taskflow?"],
